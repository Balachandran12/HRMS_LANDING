<div class=" mt-10 md:mt-24" id="price">
    ...
    <p class="mt-10 font-normal text-center"> We believe in providing a comprehensive solution without hidden
        ...
        <div class="md:flex md:justify-center sm:flex sm:justify-center">
            <div class="lg:flex gap-x-10 lg:justify-between">
                <livewire:layouts.pricing-card  plans="STANDARD PLAN" img="/assets/icons/standard.svg" />
                <livewire:layouts.pricing-card  plans="PREMIUM PLAN" img="/assets/icons/premium.svg" />
                <livewire:layouts.pricing-card  plans="ULTIMATE PLAN" img="/assets/icons/ultimate.svg" />
            </div>
        </div>
