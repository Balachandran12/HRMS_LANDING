    ...
    <div class=" container mx-auto px-5 ">
        <header class="flex justify-between items-center pt-5 ">
            ...
            <ul class="lg:flex justify-between gap-x-8 items-center hidden ">
                <li class="hover:-translate-y-1 hover:transform hover:ease-in-out duration-300 "><a href="/" class=" text-lg font-medium hover:border-b-2 border-[#FFDE17]  hover:-translate-y-4  hover:duration-100">Home</a></li>
